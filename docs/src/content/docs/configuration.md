---
title: Configuration
description: Configure agentdx for your needs
---

## Config File Location

agentdx stores its configuration in `.agentdx/config.yaml` in your project root.

Run `agentdx init` to create a default configuration.
...
store:
  ...
  postgres:
    dsn: postgres://user:pass@localhost:5432/agentdx
...
The index is stored automatically in `.agentdx/index.gob`.
...
agentdx provides two optional search enhancements:
...
See [Search Boost](/agentdx/search-boost/) for full documentation.
...
See [Hybrid Search](/agentdx/hybrid-search/) for full documentation.
