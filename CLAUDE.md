...
agentdx is a semantic code search CLI tool that indexes code using vector embeddings for natural language queries.
...
agentdx search "database connection pool"
