...
Thank you for your interest in contributing to agentdx! This document provides guidelines and instructions for contributing.
...
2. Clone your fork:
   ```bash
   git clone https://github.com/YOUR_USERNAME/agentdx.git
   cd agentdx
   ```
3. Add the upstream remote:
   ```bash
   git remote add upstream https://github.com/doveaia/agentdx.git
   ```
