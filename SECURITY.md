...
We take security seriously. If you discover a security vulnerability in agentdx, please report it responsibly.
...
- The `.agentdx/` directory should not be shared
- Add `.agentdx/` to your `.gitignore`
...
2. **Index Files**: The `.agentdx/index.gob` contains embeddings of your code
