...
var (
	...
	rootCmd = &cobra.Command{
		...
		Long: `agentdx is a privacy-first semantic code search tool.

Unlike grep (exact text matching), agentdx indexes the meaning of your code
