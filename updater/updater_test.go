...
func TestFindAssets(t *testing.T) {
	...
	expectedName := "agentdx_1.0.0_" + runtime.GOOS + "_" + runtime.GOARCH + ext
...
func TestFindAssets_NoMatchingAsset(t *testing.T) {
	...
	release := &ReleaseInfo{
		TagName: "v1.0.0",
		Assets: []Asset{
			{Name: "agentdx_1.0.0_other_arch.tar.gz", BrowserDownloadURL: "https://example.com/asset"},
		},
	}
...
func TestCheckWritePermission(t *testing.T) {
	...
	err := checkWritePermission(filepath.Join(tempDir, "agentdx"))
	if err != nil {
...
func TestCheckWritePermission_NonExistentDir(t *testing.T) {
	err := checkWritePermission("/nonexistent/path/agentdx")
	if err == nil {
