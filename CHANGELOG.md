...
- **Self-Update Command**: New `agentdx update` command for automatic updates (#42)
  - `agentdx update --check`: Check for available updates without installing
  - `agentdx update`: Download and install the latest version from GitHub releases
  - `agentdx update --force`: Force update even if already on latest version
...
- **Compact JSON Output**: New `--compact`/`-c` flag for `agentdx search` command (#33)
  - Outputs minimal JSON without `content` field for ~80% token savings
  - Requires `--json` flag (returns error if used alone)
  - Recommended format for AI agents: `agentdx search "query" --json --compact`
...
- **Claude Code Subagent**: New `--with-subagent` flag for `agentdx agent-setup` (#17)
  - Creates `.claude/agents/deep-explore.md` for Claude Code
  - Provides a specialized exploration agent with agentdx search and trace access
  - Uses `model: inherit` to match user's current model
  - Subagents operate in isolated context, ensuring agentdx tools are available during exploration
...
### Added
- **MCP Server Mode**: New `agentdx mcp-serve` command for Model Context Protocol integration (#18)
  - Exposes agentdx as native MCP tools for AI agents (Claude Code, Cursor, Windsurf, etc.)
  - Available tools: `agentdx_search`, `agentdx_trace_callers`, `agentdx_trace_callees`, `agentdx_trace_graph`, `agentdx_index_status`
...
### Added
- **Agent Setup Trace Instructions**: Updated `agentdx agent-setup` to include trace command documentation (#16)
...
### Added
- **Search JSON Output**: New `--json`/`-j` flag for `agentdx search` command
...
### Added
- **Call Graph Tracing**: New `agentdx trace` command for code navigation
...
- Separate symbol index stored in `.agentdx/symbols.gob`
- JSON output for AI agent integration (`--json` flag)
- Automatic symbol indexing during `agentdx watch`
...
### Added
- Initial release of agentdx
- `agentdx init` command for project initialization
- `agentdx watch` command for real-time file indexing
- `agentdx search` command for semantic code search
- `agentdx agent-setup` command for AI agent integration
...
[Unreleased]: https://github.com/yoanbernabeu/agentdx/compare/v0.14.0...HEAD
[0.14.0]: https://github.com/yoanbernabeu/agentdx/compare/v0.13.0...v0.14.0
[0.13.0]: https://github.com/yoanbernabeu/agentdx/compare/v0.12.0...v0.13.0
[0.12.0]: https://github.com/yoanbernabeu/agentdx/compare/v0.11.0...v0.12.0
[0.11.0]: https://github.com/yoanbernabeu/agentdx/compare/v0.10.0...v0.11.0
[0.10.0]: https://github.com/yoanbernabeu/agentdx/compare/v0.9.0...v0.10.0
[0.9.0]: https://github.com/yoanbernabeu/agentdx/compare/v0.8.1...v0.9.0
[0.8.1]: https://github.com/yoanbernabeu/agentdx/compare/v0.8.0...v0.8.1
[0.8.0]: https://github.com/yoanbernabeu/agentdx/compare/v0.7.2...v0.8.0
[0.7.2]: https://github.com/yoanbernabeu/agentdx/compare/v0.7.1...v0.7.2
[0.7.1]: https://github.com/yoanbernabeu/agentdx/compare/v0.7.0...v0.7.1
[0.7.0]: https://github.com/yoanbernabeu/agentdx/compare/v0.6.0...v0.7.0
[0.6.0]: https://github.com/yoanbernabeu/agentdx/compare/v0.5.0...v0.6.0
[0.5.0]: https://github.com/yoanbernabeu/agentdx/compare/v0.4.0...v0.5.0
[0.4.0]: https://github.com/yoanbernabeu/agentdx/compare/v0.3.0...v0.4.0
[0.3.0]: https://github.com/yoanbernabeu/agentdx/compare/v0.2.0...v0.3.0
[0.2.0]: https://github.com/yoanbernabeu/agentdx/compare/v0.1.0...v0.2.0
[0.1.0]: https://github.com/yoanbernabeu/agentdx/releases/tag/v0.1.0
